-- ============================================================
-- PostgreSQL Migration — Dapur Tradisional Ibu Enuy
-- Jalankan di cPanel Domainesia → phpPgAdmin
-- Database: digiflaz_enuycommerce
-- ============================================================
...
INSERT INTO products
  (id, name, price, description, img, status, status_label, variants, unit, stock, sort_order)
VALUES
  ...
  ('burayot', 'Burayot', 40000,
   ...
   '/images/Burayot.jpeg', 'preorder', 'Pre Order',
   '[]', 'mika', -1, 2),
  ('rengginang', 'Rengginang', 25000,
   'Gurih, Nikmat, Nyoss — 10 pcs/pack',
   '/images/RENGGINANG.jpg', 'ready', 'Ready Stock',
   '[]', 'pack', -1, 3)
